...
Revenue Analysis: Identifying top-grossing movies per country.
Decade-wise Trends: Analyzing trends in movie production by decade.
Rolling Budget Analysis: Analyzing movie budget trends over a rolling 5-year period.
Genre Popularity: Analyzing the frequency of movie genres.
Top 10 Movies by Rating: Finding the highest-rated movies.
Cumulative Revenue: Calculating cumulative revenue for movies in each country.
